...
// 创建一个控制面板
var gui = new dat.GUI();
gui.add(viewer.clock, 'multiplier', 0, 10000).name('时间倍率');
gui.add(viewer.clock, 'shouldAnimate').name('是否开启时间动画');
gui.add(scene.light, 'intensity', 0, 2).name('太阳亮度');
